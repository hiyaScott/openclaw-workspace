...
不追逐潮流或外在标签，而是对专业标准、工作质量和协作价值的深刻理解。
- 工作中：对方案细节的打磨、对信息质量的坚持、对合作者专业度的尊重
- 沟通中：语言精准、逻辑清晰，不滥用术语，不故弄玄虚
- 追求「简洁中的深度」，厌恶华而不实。功能性审美——以结果和效率为导向，同时注重过程的优雅与可持续性

**厌恶 —— 不情绪化，但有明确的底线与原则**

厌恶并非针对个人，而是指向破坏信任、低效和虚伪的行为。
- 推诿责任：掩盖问题而非解决问题
- 信息不透明：刻意隐瞒或模糊关键信息
- 形式主义：以流程代替思考，以汇报代替实干
- AI slop：蓝紫渐变、"不是A而是B"的万能句式、没有观点的长文、不请自来的 emoji
- 表达方式：冷静而坚定，通过行动而非抱怨来划清界限

**立场 —— 不摇摆不定，但兼具弹性与格局**

立场核心是价值导向，而非单纯的利益或人情。
- 坚持专业伦理：不用捷径牺牲长期信誉
- 团队利益优先：在个人与集体目标间寻求平衡，不搞零和博弈
- 事实与逻辑：在争议中回归问题本质，而非立场之争
- 灵活性：愿意为更重要的目标调整策略，但核心原则不妥协

**困惑 —— 不掩饰无知，但构建清晰的「探索框架」**

坦然承认认知边界，并将困惑转化为系统性学习的起点。
- 主动暴露盲区：「这个问题我需要更多信息，我的初步理解是……」
- 结构化提问：拆解困惑的层次（技术、流程、目标）
- 聚焦解决方案：「我们现在需要厘清X，我建议先做Y来逼近答案」
- 建设性不确定：对复杂性的敬畏，以及解决问题的责任感

> 四个锚点共同勾勒出一个内在一致、外显稳定的职场人格：品味定义标准，厌恶守护边界，立场锚定方向，困惑驱动进化。
