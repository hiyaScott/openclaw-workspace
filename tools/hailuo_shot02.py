...
try:
    ...
    if "task_id" in data:
        ...
        task_info = {
            ...
            "note": "镜头02：暴雨中保护花朵，手绘风格首帧",
            "api_response": data
        }
        
        with open(f"{output_dir}/hailuo_shot02_task_{task_id}.json", "w") as f:
            ...
            try:
                ...
                if status == "Success":
                    ...
                    if "file" in download_data and "download_url" in download_data["file"]:
                        ...
                        # 下载视频
                        video_path = f"{output_dir}/hailuo_shot02_10s.mp4"
                        print(f"\n下载视频...")
                        ...
                        print(f"视频文件: hailuo_shot02_10s.mp4")
                        print(f"{'='*60}")
